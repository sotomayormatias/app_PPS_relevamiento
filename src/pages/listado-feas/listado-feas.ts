...
@IonicPage()
@Component({
  selector: 'page-listado-feas',
  templateUrl: 'listado-feas.html',
})
export class ListadoFeasPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ListadoFeasPage');
  ...
  votar(key: string, votos: number) {
    ...
    firebase.database().ref('fotosfeas/' + key).update(objeto);
    this.downloadImageUrls();
  }
